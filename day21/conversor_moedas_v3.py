...
def buscar_taxa_cambio(moeda_origem, moeda_destino, api_key):
    ...
    """
    url = f"http://api.exchangeratesapi.io/v1/latest?access_key={api_key}&base={moeda_origem}&symbols={moeda_destino}"
...
# Faça uma conta gratuita no Exchange generates para testar, atenção a conta gratuita só permite conversões de EUR para outras moedas
